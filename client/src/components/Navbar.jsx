...
function Navbar(){
    ...
    return (
        ...
        <h1 className='md:font-bold font-semibold md:text-2xl text-lg text-[#2563EB]'>ExpenseIQ</h1>
      </Link>
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <Link to="/expense-list">
            <div className="flex flex-col items-center cursor-pointer hover:text-[#2563EB] ">
      ...
      <div className="flex  items-center space-x-4 relative">
        <button onClick={()=>setOpen(true)} className="relative">
            ...
            { unreadCount >0 &&(
                <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-1 ">{unreadCount}</span>
            )
            }
        </button>
            ...
            {isDropDownOpen &&(
                <div className="absolute right-0 w-36 mt-2 bg-white shadow-lg rounded-md p-2">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <button onClick={handleLogout}className="px-2 py-1 font-medium  hover:bg-[#2563EB] hover:text-white rounded-md flex  items-center gap-1 cursor-pointer">
      ...
      {menuOpen && (
        ...
        >
          <div className='flex items-center px-6 py-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b border-gray-100'>
