import { Coins, ChartLine, Bot, CreditCard, PiggyBank,  TrendingUp, Brain } from "lucide-react";
import { Link } from "react-router-dom";


function Hero(){
    return (
        <section className="px-6 py-12 text-center  md:py-20 bg-linear-to-b from-white to-[#F9FAFB] relative">
            ...
            <p className=" mt-4 text-md text-[#6B7280] md:text-lg md:mt-6 max-w-xl  mx-auto">
            ...
            <div className="mt-6 flex justify-center gap-3">
                <Link to='/register' className="px-5  py-2.5 text-sm font-semibold rounded-lg bg-[#2563EB] text-white shadow-md hover:opacity-90 transition duration-300">Get Started</Link>
