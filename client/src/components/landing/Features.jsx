import { Bell,Wallet,Shield,BarChart3}from 'lucide-react';
...
function Features(){
   return (
    <section id="features" className='bg-[#F9FAFB]  md:py-16 py-10 px-4'>
        <div className='max-w-6xl mx-auto md:mb-12 mb-8 text-center'>
        ...
        <div className='max-w-6xl mx-auto grid md:gap-8  gap-4 md:grid-cols-2 lg:grid-cols-4'>
            {features.map((feature,idx)=>(
                <div key={idx} className='bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition'>
                    <div className='flex items-center justify-center md:mb-2 mb-4'>
                        {features.icon}
                    </div>
