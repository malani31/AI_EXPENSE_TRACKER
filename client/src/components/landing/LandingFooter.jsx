            ...
            <div className='max-w-6xl mx-auto grid gap-8 md:grid-cols-3'>
                <div>
                    <div className='flex items-center mb-2 gap-2'>
                        ...
                        <h2 className='text-lg font-semibold md:mb-2 mb-1'>ExpenseIQ</h2>
                ...
                <div>
                    ...
                    <p className='text-sm text-gray-400'>contact@expenseiq.com</p>
                    <p className='text-sm text-gray-400'>Developer: <a href="https://olapuajay.github.io/portfolio/" target='_blank'>prince</a></p>
                </div>
            </div>
