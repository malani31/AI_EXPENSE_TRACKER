        ...
        <div className="min-h-screen flex items-center justify-between  bg-gray-50 px-4">
            ...
            <div className="max-w-lg w-full bg-white shadow-lg rounded-2xl p-6">
                <div className=" flex flex-col items-center justify-center ">
                    ...
                    <h2 className=" text-2xl font-bold text-center text-gray-900 mb-6"> Welcome back to ExpenseIQ</h2>
                </div>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type='submit' disabled={loading} className="w-full text-white py-2 rounded-md  bg-[#2563EB] font-medium hover:bg-blue-700 disabled:opacity-50 cursor-pointer transition duration-300">
                        {loading ? (
